<template>
  <!-- ============================================================
       ...
       TAB: info | education | skills | security
            ...
            <div class="form-grid">
                ...
                <div class="tag-select">
                  ...
                  >
                    ...
                    <button
                      ...
                      type="button"
                      class="tag-toggle-btn"
                      @click="toggleWorkMode(opt.value)"
                    >
              ...
              <div class="form-group full">
                ...
                <input
                  ...
                  :disabled="!editMode"
                  type="text"
                  placeholder="Frontend, Backend, Data Analyst, Tester"
                />
              ...
              <div class="form-group full">
                ...
                <input
                  ...
                  :disabled="!editMode"
                  type="text"
                  placeholder="Frontend Developer Intern, Backend Intern"
                />
                <small>Ngăn cách bằng dấu phẩy</small>
              </div>
              ...
              <div class="form-group full">
                ...
                <textarea
                  ...
                  :disabled="!editMode"
                  rows="3"
                  placeholder="Website tìm việc sinh viên, Hệ thống quản lý quán cafe"
                ></textarea>
                <small>Ngăn cách bằng dấu phẩy</small>
              </div>
              ...
              <div class="form-group full">
                ...
                <input
                  ...
                  :disabled="!editMode"
                  type="text"
                  placeholder="VueJS, NodeJS, MongoDB"
                />
                <small>Ngăn cách bằng dấu phẩy</small>
              </div>
              ...
              <div class="form-group full">
                ...
                <input
                  ...
                  :disabled="!editMode"
                  type="text"
                  placeholder="TOEIC 750, MOS, Google Data Analytics"
                />
                <small>Ngăn cách bằng dấu phẩy</small>
              </div>
...
const profileCompletion = computed(() => {
  return Math.round((completedCount.value / profileRequirements.value.length) * 100)
})
...
.tag-option.tag-selected .tag-toggle-btn {
  background: #dc3545;
}
